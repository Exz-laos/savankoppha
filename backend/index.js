...
const allowedOrigins = ['https://savankoppha-x.vercel.app']; // Add more origins if needed
...
app.use(cors({
  ...
  credentials: true, // Enable this if you are using cookies or credentials
  methods: ['GET', 'POST', 'PUT', 'DELETE'], // Add other methods if required
